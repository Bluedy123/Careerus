    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <header className="bg-black text-white py-20 text-center">
        ...
        <p className="text-lg mt-4 text-gray-300 max-w-3xl mx-auto">
          Empowering individuals with career insights, skill recommendations,
      ...
      <section className="max-w-6xl mx-auto py-16 px-6 text-center">
        ...
        <p className="text-lg text-gray-700 mt-4 leading-relaxed">
          CareerUS is designed to help individuals find the best career paths,
          assess skill gaps, and gain insights into job trends. We provide
          career recommendations tailored to each user’s strengths and
          interests.
        </p>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-8">
            <div className="p-6 bg-gray-200 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mt-2">
                We use data to offer personalized career insights and
                recommendations.
              </p>
            </div>
            <div className="p-6 bg-gray-200 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mt-2">
                Our platform enables users to take control of their career
                growth and success.
              </p>
            </div>
            <div className="p-6 bg-gray-200 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mt-2">
                We provide clear, data-backed insights to help users make
                informed decisions.
              </p>
            </div>
          </div>
      ...
      <section className="text-center py-16">
        ...
        <p className="text-lg text-gray-700 mt-4">
          Start exploring your career path with data-driven insights and skill
          recommendations.
        </p>
        <div className="mt-6">
