            ...
            <body className="bg-gray-100">
                <AppRouterCacheProvider>
                    ...
                    <nav className="bg-black text-gray-300 flex items-center justify-between px-10 py-5 shadow-lg">
                        <Link
                            href="/"
                            className="text-4xl font-extrabold tracking-wide uppercase hover:opacity-80 transition"
                        >
                        ...
                        <div className="flex space-x-4">
                            {user ? (
                                ...
                                <>
                                    <Link
                                        href="/auth/login"
                                        className="px-4 py-2 text-white bg-gray-700 rounded-md font-medium hover:bg-gray-800 transition"
                                    >
                                        Sign In
                                    </Link>
                                    <Link
