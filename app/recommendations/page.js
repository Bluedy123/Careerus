...
export default function Recommendations() {
  const API_KEY = "28861c5339msh90e89ca9d340422p1e26b3jsn5059155d06a0"; // Replace with your actual API key

  // Mock user skills (In a real app, fetch from user profile)
  const [userSkills, setUserSkills] = useState(["JavaScript", "React", "Python"]);
  ...
  useEffect(() => {
    const fetchRecommendations = async () => {
      try {
        const skillQuery = userSkills.join(" "); // Convert skills to a single search query
        ...
        setRecommendations(data.data || []); // Store recommended jobs
      } catch (error) {
    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <header className="bg-black text-white py-20 text-center">
        ...
        <p className="text-lg mt-4 text-gray-300 max-w-3xl mx-auto">
          Personalized career suggestions based on your profile and market trends.
        </p>
      </header>
