...
export default function Recommendations() {
  ...
  // Fetch user's skills (in a real app, this would come from the profile API)
  useEffect(() => {
    if (isLoggedIn) {
      // Simulate fetching skills from profile
    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      {!isLoggedIn ? (
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
          <p className="text-xl text-gray-700">Please sign in to view your recommendations.</p>
