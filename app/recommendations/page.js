                        ...
                        <div className="mt-8 space-y-6">
                            {recommendations.map((career, index) => (
                                ...
                                >
                                    ...
                                    <p className="text-gray-700 mt-2">
                                        📍 Location: {career.job_city},{" "}
                                        {career.job_country}
                                    </p>
                                    <p className="text-gray-700 mt-2">
                                        💰 Salary:{" "}
                                        {career.job_min_salary
                                            ? `$${career.job_min_salary} - $${career.job_max_salary}`
                                            : "Not listed"}
                                    </p>
                                    <a
                    ...
                    <section className="max-w-6xl mx-auto py-16 px-6">
                        ...
                        <div className="mt-8 space-y-4">
                            {savedCareers.map((career, index) => (
                                <div
                                    key={index}
                                    className="bg-gray-200 p-4 rounded-lg text-gray-900 font-semibold text-center"
                                >
                                    {career}
                                </div>
                            ))}
